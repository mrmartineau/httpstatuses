...
function startPreviewServer() {
  ...
  console.log(
    'A local webserver has been launched, visit http://localhost:4887 in your browser to preview your build.'
  )
  console.log('Exit this process to kill the webserver :-)')
  console.log(
    'To build without the local webserver use `node build without-preview`'
  )
}
